#ifndef MOTOMAN_DEMO__MOTOMAN_KITTING_HPP_
#define MOTOMAN_DEMO__MOTOMAN_KITTING_HPP_
...
class MotomanDemo : public rclcpp::Node
{
public:
  /// Constructor
  MotomanDemo();
  ...
  void MotomanSendHome();
  bool MotomanOpenGripper();
  bool MotomanCloseGripper();
  bool BuildTarget();
...
private:
  ...
  std::pair<bool, moveit_msgs::msg::RobotTrajectory> MotomanPlantoTarget();
  std::pair<bool, moveit_msgs::msg::RobotTrajectory> MotomanPlanCartesian(std::vector<geometry_msgs::msg::Pose> waypoints, double vsf, double asf, bool avoid_collisions);
  bool MotomanSendTrajectory(moveit_msgs::msg::RobotTrajectory trajectory);
  double calculateDistance(const geometry_msgs::msg::Pose& pose1, const geometry_msgs::msg::Pose& pose2);

  // MoveIt Interfaces
  moveit::planning_interface::MoveGroupInterface motoman_arm_;
  ...
  // Publishers
  rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr motoman_position_publisher_;
...
#endif  // MOTOMAN_DEMO__MOTOMAN_KITTING_HPP_